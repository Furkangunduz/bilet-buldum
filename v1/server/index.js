...
const { createJob, finishSingleJob } = require("./script/cronJob");
const { removeUserFromUserList, logActiveUsers } = require("./utils/user");
const { sendMail } = require("./script/mail");
const { saveUserToDb, getAllUsersFromDb, deleteUserFromDb } = require("./service/db");
const { respondText } = require("./utils/const_respond_texts");
...
getAllUsersFromDb().then((response) => {
